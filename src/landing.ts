...
const en: LandingContent = {
  ...
  steps: [
    ...
    { text: "When the event is over, its administrator closes it with /closeevent, which sends the final passcode to every participant." },
  ],
  ...
  commandGroups: [
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/verify <code>", description: "Paste a code confirmed correct at the game's redeem screen; resolves every position from it at once and closes the event." },
...
const ca: LandingContent = {
  ...
  steps: [
    ...
    { text: "Quan l'esdeveniment s'acaba, qui l'administra el tanca amb /closeevent, que envia el passcode final a tots els participants." },
  ],
  ...
  commandGroups: [
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/verify <codi>", description: "Enganxa un codi confirmat correcte a la pantalla de bescanvi del joc; resol totes les posicions a partir d'ell alhora i tanca l'esdeveniment." },
...
const es: LandingContent = {
  ...
  steps: [
    ...
    { text: "Cuando el evento termina, quien lo administra lo cierra con /closeevent, que envía el passcode final a todos los participantes." },
  ],
  ...
  commandGroups: [
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/verify <código>", description: "Pega un código confirmado correcto en la pantalla de canje del juego; resuelve todas las posiciones a partir de él a la vez y cierra el evento." },
...
const fr: LandingContent = {
  ...
  steps: [
    ...
    { text: "Une fois l'événement terminé, son administrateur le clôture avec /closeevent, ce qui envoie le passcode final à tous les participants." },
  ],
  ...
  commandGroups: [
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/verify <code>", description: "Colle un code confirmé correct à l'écran d'échange du jeu ; résout toutes les positions à partir de lui d'un coup et clôture l'événement." },
