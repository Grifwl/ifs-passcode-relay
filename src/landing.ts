  ...
  commandGroups: [
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/leave", description: "Leave your current event. If you're the creator, another participant automatically takes over (trusted ones first, then whoever's contributed the most), or the event closes as unfinished if no one is eligible." },
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/promote <user>", description: "Hand the creator role to another participant already in the event; marks them trusted too, the same way /newevent does for its own creator." },
  ...
  commandGroups: [
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/leave", description: "Surt de l'esdeveniment actual. Si ets qui l'ha creat, un altre participant assumeix el rol automàticament (primer els de confiança, si no qui hagi aportat més), o es tanca com a inacabat si no hi ha ningú apte." },
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/promote <usuari>", description: "Cedeix el rol de creador a un altre participant ja unit a l'esdeveniment; també el marca de confiança, igual que /newevent fa amb qui crea l'esdeveniment." },
  ...
  commandGroups: [
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/leave", description: "Sal del evento actual. Si eres quien lo ha creado, otro participante asume el rol automáticamente (primero los de confianza, si no quien más haya aportado), o se cierra como inacabado si no hay nadie apto." },
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/promote <usuario>", description: "Cede el rol de creador a otro participante ya unido al evento; también lo marca de confianza, igual que /newevent hace con quien crea el evento." },
  ...
  commandGroups: [
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/leave", description: "Quitter l'événement actuel. Si vous êtes le créateur, un autre participant reprend automatiquement le rôle (les fiables en priorité, sinon celui ayant le plus contribué), ou l'événement est clôturé comme inachevé si personne n'est éligible." },
    ...
    },
    {
      ...
      rows: [
        ...
        { command: "/promote <utilisateur>", description: "Transfère le rôle de créateur à un autre participant déjà dans l'événement ; le marque aussi comme fiable, comme /newevent le fait pour son propre créateur." },
