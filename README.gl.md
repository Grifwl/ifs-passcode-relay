<!-- Languages: [English](README.md) | [Català](README.ca.md) | [Castellano](README.es.md) | [Français](README.fr.md) | Galego | [Euskara](README.eu.md) | [Português](README.pt.md) | [Italiano](README.it.md) | [Deutsch](README.de.md) -->
...
**Idiomas:** [English](README.md) · [Català](README.ca.md) · [Castellano](README.es.md) · [Français](README.fr.md) · Galego · [Euskara](README.eu.md) · [Português](README.pt.md) · [Italiano](README.it.md) · [Deutsch](README.de.md)
...
| `/language <código>` | calquera | Establece o teu idioma (`en`, `ca`, `es`, `fr`, `gl`, `eu`, `pt`, `it`, `de`). |
...
mesmos menús, engade as versións `ca`/`es`/`fr`/`gl`/`eu`/`pt`/`it`/`de` de abaixo
