<!-- Languages: [English](README.md) | [Català](README.ca.md) | [Castellano](README.es.md) | [Français](README.fr.md) | [Galego](README.gl.md) | Euskara | [Português](README.pt.md) | [Italiano](README.it.md) | [Deutsch](README.de.md) -->
...
**Hizkuntzak:** [English](README.md) · [Català](README.ca.md) · [Castellano](README.es.md) · [Français](README.fr.md) · [Galego](README.gl.md) · Euskara · [Português](README.pt.md) · [Italiano](README.it.md) · [Deutsch](README.de.md)
...
| `/language <kodea>` | edonork | Zure hizkuntza ezartzen du (`en`, `ca`, `es`, `fr`, `gl`, `eu`, `pt`, `it`, `de`). |
...
berdinetatik, gehitu beheko `ca`/`es`/`fr`/`gl`/`eu`/`pt`/`it`/`de` bertsioak
