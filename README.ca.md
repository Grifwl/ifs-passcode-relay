<!-- Languages: [English](README.md) | Català | [Castellano](README.es.md) | [Français](README.fr.md) | [Galego](README.gl.md) | [Euskara](README.eu.md) | [Português](README.pt.md) | [Italiano](README.it.md) | [Deutsch](README.de.md) -->
...
**Idiomes:** [English](README.md) · Català · [Castellano](README.es.md) · [Français](README.fr.md) · [Galego](README.gl.md) · [Euskara](README.eu.md) · [Português](README.pt.md) · [Italiano](README.it.md) · [Deutsch](README.de.md)
...
| `/language <codi>` | tothom | Estableix el teu idioma (`en`, `ca`, `es`, `fr`, `gl`, `eu`, `pt`, `it`, `de`). |
...
des dels mateixos menús, afegeix les versions `ca`/`es`/`fr`/`gl`/`eu`/`pt`/`it`/`de` de
