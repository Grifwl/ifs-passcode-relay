<!-- Languages: [English](README.md) | [Català](README.ca.md) | [Castellano](README.es.md) | Français | [Galego](README.gl.md) | [Euskara](README.eu.md) -->
...
**Langues :** [English](README.md) · [Català](README.ca.md) · [Castellano](README.es.md) · Français · [Galego](README.gl.md) · [Euskara](README.eu.md)
...
| `/language <code>` | tout le monde | Définit votre langue (`en`, `ca`, `es`, `fr`, `gl`, `eu`). |
...
les mêmes menus, ajoutez les versions `ca`/`es`/`fr`/`gl`/`eu` ci-dessous
